...
public class GuiLobby extends Application {
    ...
    public void start(Stage stage) {
        ...
        try {
            Parent root = FXMLLoader.load(getClass().getClassLoader().getResource("sampleLobby.fxml"));
            root.setId("pane");

            Scene scene = new Scene(root, DEFAULT_MIN_WIDTH, DEFAULT_MIN_HEIGHT);
            scene.getStylesheets().addAll(this.getClass().getClassLoader().getResource("styleLobby.css").toExternalForm());
